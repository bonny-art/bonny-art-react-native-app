...
export const MODAL_WIDTH_PERCENTAGE = "82%";
export const MODAL_MAX_WIDTH = mscale(360);

export const LOGOUT_MODAL_TITLE = "Log out";
export const LOGOUT_MODAL_MESSAGE =
  "Are you sure you want to log out? You'll need to log in again to use all functionality of the app.";
